        ...
        <div>
            <div className='bg-slate-800 border-slate-400 rounded-md p-8 shadow-lg backdrop-blur-sm backdrop-filter bg-opacity-25 relative'>
                ...
                <form onSubmit={handleUser}>
                    ...
                    <div className='relative my-4'>
                        <input id="email" type="email" placeholder='' onChange={(e)=>setNewUser({...newUser,email:e.target.value})} className='peer block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600'/>
                    ...
                    <div className='relative my-4'>
                        <input id="password" type="password" placeholder='' onChange={(e)=>setNewUser({...newUser,password:e.target.value})} className='peer block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600'/>
                    ...
                    <div className='relative my-4'>
                        <input id="password2" type="password" placeholder='' className='peer block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600'/>
